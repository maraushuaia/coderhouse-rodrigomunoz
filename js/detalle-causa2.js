const buscarDetalles = (idCausa, cuil) => {
    ...
    console.log("Entró a Buscar Detalles..");
    
    if (encontrado != null) {
        imprimir += 
            `<div class="row row-cols-1 mb-3 pt-3">
                <!-- Nav tabs -->
                <div class="container">
           ...
           document.getElementById("detallesDeCausa").innerHTML = imprimir;
            ...
            document.getElementById("caratulaDeCausa").innerHTML = imprimir;
        }
